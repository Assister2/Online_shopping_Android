...
class ShopSliderAdapter(val context: Context, val bannerList: StoreDetailsModel) : PagerAdapter() {
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        Picasso.get().load(context.resources.getString(R.string.imageUrl)+bannerList.data!![position].sliders[position]).into(iv_banner)
        return view
    }
